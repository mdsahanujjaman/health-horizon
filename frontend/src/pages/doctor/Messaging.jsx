        ...
        <div className="min-h-screen bg-gray-50 flex">
            ...
            <main className="flex-1 p-8 overflow-y-auto relative">
                <div className="max-w-4xl mx-auto space-y-8 relative z-10">
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-slate-500 font-medium mt-1">
                                Communicate with your patients and review their inquiries.
                            </p>
                        </div>
                        <NotificationBell />
                    </div>
                    ...
                    {/* Conversations List */}
                    <div className="bg-white rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden divide-y divide-slate-100">
                        {filteredConversations.length === 0 ? (
                            <div className="p-20 text-center">
                                <div className="w-20 h-20 bg-slate-50 rounded-full flex items-center justify-center mx-auto mb-6">
                                    <MessageCircle className="w-10 h-10 text-slate-200" />
                                </div>
                                <h3 className="text-xl font-bold text-slate-900 mb-2">No messages found</h3>
                            ...
                            filteredConversations.map((conv) => (
                                <div
                                    ...
                                    className="p-8 flex items-center gap-6 hover:bg-slate-50/80 transition-all cursor-pointer group"
                                >
                                    <div className="w-16 h-16 bg-white border-2 border-slate-100 rounded-2xl flex items-center justify-center shadow-sm group-hover:border-primary group-hover:scale-105 transition-all overflow-hidden relative">
                                        {conv.participantProfilePictureUrl ? (
                                            <img
                                                src={`http://localhost:8080${conv.participantProfilePictureUrl}`}
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <p className="text-slate-500 font-medium truncate pr-10">
